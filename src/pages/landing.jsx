...
return (
    <div className='flex flex-col items-center'>
        ...
        className='sm:h-14 flex flex-col sm:flex-row w-full md:w-2/4 gap-2'>
          <Input
            type="url" placeholder="Enter your looonggg URL"
            value={longUrl}
            onChange={ (e) => setLongUrl(e.target.value)}
            className="h-full flex-1 py-4 px-4 text-purple-900"
            />
           <Button
            
            className="h-full rounded-full" type= "submit" variant ="destructive" >Shorten it!</Button>
        </form>
        <img src="banner.png" alt="banner" className="w-full my-11 md: px-11"/>
        <Accordion type="multiple" collapsible className='w-full md:px-11'>
            <AccordionItem value="item-1">
               <AccordionTrigger>How does the TrXmmr URL shortener works?</AccordionTrigger>
